...
{
	///////////////////////////////////////////////
	const VRString CEntityManagerFactory::FACTORY_TYPE_NAME = ENTITYSYSTEM_TYPENAME;
	///////////////////////////////////////////////

	CEntitySystem::CEntitySystem(const VRString& strName):
	...
	// 获取类型名称
	const VRString& CEntitySystem::GetTypeName(void) const
	{
		return (CEntityManagerFactory::FACTORY_TYPE_NAME);
	}
	...
	// 注册界面
	void CEntitySystem::RegisterUI(const EntityManager_Typ emt, IPluginUI* pPluginUI)
	{
		if (emt == EMT_ADDED)
		{
	...
	// 卸载界面
	void CEntitySystem::UnRegisterUI(const EntityManager_Typ emt,IPluginUI* pPluginUI)
	{
		if (emt == EMT_ADDED)
		{
			RegisterAddedUI(pPluginUI);
