...
namespace VR_Soft
{
	const VRString LOGSYSTEM_TYPENAME = "LOGSYSTEM_TYPENAME";
	const VRString INSTANCE_NAME_LOGSYSTEM = "LOGSYSTEM";
	const VRString LOGSYSTEM_DISC = "日志系统";

	class VRSOFT_PLUGIN_DLL ILogManager : public CSingleton<ILogManager>, public IComManagerFace
	{
	public:
		// 析构函数
		virtual ~ILogManager() { }
